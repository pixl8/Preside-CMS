component extends="preside.system.base.AdminHandler" {
	...
	public void function addPageAction( event, rc, prc ) {
		...
		formData             = event.getCollectionForForm( formName=formName, stripPermissionedFields=true, permissionContext="page", permissionKeys=( prc.pagePermissionContext ?: [] ) );
		formData.parent_page = parent;
		formData.page_type   = rc.page_type;

		validationResult = validateForm( formName=formName, formData=formData, stripPermissionedFields=true, permissionContext="page", permissionKeys=( prc.pagePermissionContext ?: [] ) );
	...
	public void function restorePageAction( event, rc, prc ) {
		...
		var formData          = event.getCollectionForForm( formName=formName, stripPermissionedFields=true, permissionContext="page", permissionKeys=( prc.pagePermissionContext ?: [] ) );
		var validationResult  = "";
		var newId             = "";
		var persist           = "";
