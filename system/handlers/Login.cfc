...
// core events
	public void function attemptLogin( event, rc, prc ) output=false {
		...
		var postLoginUrl = websiteLoginService.getPostLoginUrl( explicitUrl=rc.postLoginUrl ?: "", defaultUrl=cgi.http_referer ?: "" );
...
// page type viewlets
	private string function loginPage( event, rc, prc, args={} ) output=false {
		...
		args.postLoginUrl    = websiteLoginService.getPostLoginUrl( explicitUrl=rc.postLoginUrl ?: "", defaultUrl=event.getCurrentUrl() );
	...
	private string function forgottenPassword( event, rc, prc, args={} ) output=false {
		...
		args.postLoginUrl = websiteLoginService.getPostLoginUrl( explicitUrl=rc.postLoginUrl ?: "", defaultUrl=cgi.http_referer ?: "" );
