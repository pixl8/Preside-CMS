component output=false {
	...
	public string function index( event, rc, prc, args={} ) output=false {
		...
		args.prefetchUrl = event.buildAdminLink( linkTo="assetmanager.getAssetsForAjaxPicker", querystring="maxRows=100&allowedTypes=#allowedTypes#&prefetchCacheBuster=#prefetchCacheBuster#" );
