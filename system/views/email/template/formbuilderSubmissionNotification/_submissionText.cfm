...
<cfoutput>
==============
<cfif isFeatureEnabled( "websiteUsers" )>#translateResource( "preside-objects.formbuilder_formsubmission:field.submitted_by.title")#: #renderContent( 'websiteUser', args.submissionData.submitted_by, [ "textemail" ] )#
</cfif>#translateResource( "preside-objects.formbuilder_formsubmission:field.datecreated.title")#: #renderField( 'formbuilder_formsubmission', 'datecreated', args.submissionData.datecreated, [ "textemail"] )#
