...
<cfoutput>
	<div class="checkbox role-picker-checkbox">
		<label>
			<input class="ace ace-switch ace-switch-3 all-topics" name="#inputName#" id="#inputId#-all-topics" type="checkbox" value="all"<cfif ListFindNoCase( value, "all" )> checked="checked"</cfif> tabindex="#getNextTabIndex()#">
			<span class="lbl">
	...
	<cfloop array="#topics#" index="topic">
		<div class="checkbox role-picker-checkbox">
			<label class="topic-checkbox-label">
				<input class="ace ace-switch ace-switch-3 topic-checkbox" name="#inputName#" id="#inputId#-#topic#" type="checkbox" value="#topic#"<cfif ListFindNoCase( value, "all" ) or ListFindNoCase( value, topic )> checked="checked"</cfif> tabindex="#getNextTabIndex()#">
				<span class="lbl">
