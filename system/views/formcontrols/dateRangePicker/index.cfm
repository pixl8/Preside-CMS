...
<cfoutput>
	<div class="row">
		<div class="input-group col-xs-6">
		    ...
		    <input name="#fromDate#" id="#fromDate#" type="text" class="#inputClass# form-control date-picker" value="#HtmlEditFormat( from )#" data-date-format="yyyy-mm-dd" tabindex="#getNextTabIndex()#">
		</div>
		<div class="input-group col-xs-6">
