...
<cfoutput>
	...
	<input type="text" id="#inputId#" name="#inputName#" placeholder="#placeholder#" value="#value#" class="#inputClass# slug-editor form-control<cfif autoSlug> auto-slug</cfif>" tabindex="#getNextTabIndex()#"<cfif autoSlug> data-based-on="#basedOn#"</cfif>>
