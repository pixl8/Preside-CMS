...
<cfoutput>
	<cfloop array="#strengths#" index="strength">
		<div class="radio role-picker-radio">
			<label>
				<input class="ace ace-switch ace-switch-3" name="#inputName#" id="#inputId#-#strength.name#" type="radio" class="ace" value="#strength.minValue#"<cfif ListFindNoCase( value, strength.minValue )> checked="checked"</cfif> tabindex="#getNextTabIndex()#">
				<span class="lbl">
