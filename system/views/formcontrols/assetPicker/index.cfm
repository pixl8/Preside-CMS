<cfscript>
	...
	resultTemplate     = selectedTemplate = '<div class="result-container"><div class="icon-container">{{{icon}}}</div> <div class="folder-and-text"><span class="folder">{{folder}}</span> <span class="title">{{text}} <i class="text-muted">{{dimension}}</i></span></div></div>';
