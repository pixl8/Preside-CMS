	...
	<form id="add-assets-form" class="form-horizontal batch-add-assets-form" action="#event.buildAdminLink( linkto="assetmanager.addAssetsAction" )#" method="post">
		...
		<div class="row">
			<div class="col-md-5">
				...
				<div class="hide upload-next-steps">
					...
					<div class="form-actions row">
						<div class="col-md-offset-2">
							<a class="btn btn-success finished-trigger" disabled>
								<i class="fa fa-check bigger-110"></i>
								#translateResource( "cms:assetManager.upload.finished" )#
							</a>

							<a class="btn btn-default start-over" disabled>
			...
			<div class="col-md-7">
				<div class="table-responsive">
					...
					<p class="no-files-chosen-message text-center grey"><em>Choose files to begin</em></p>
				</div>
			</div>
		</div>
