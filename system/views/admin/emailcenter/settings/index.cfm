...
<cfoutput>
			...
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs">
					<li<cfif site eq ""> class="active"</cfif>>
						<cfset link = event.buildAdminLink( linkTo="emailcenter.settings" ) />
						<a href="#link#">
					...
					<cfloop query="sites">
						<li<cfif site eq sites.id> class="active"</cfif>>
							<cfset link = event.buildAdminLink( linkTo="emailcenter.settings", queryString="site=#sites.id#" ) />
							<a href="#link#">
	...
	#renderViewlet( event="admin.emailcenter.settings._generalSettingsTabs", args={ body=body, tab="general" } )#
</cfoutput>