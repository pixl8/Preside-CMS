						...
						<tr class="clickable">
							...
							<td>
								<div class="action-buttons btn-group">
									...
									<cfif systemEmailBodyIsDiffWithDefault( templateId=template.id )>
										<a href="#event.buildAdminLink( linkTo="emailcenter.systemTemplates.reset", queryString="template=#template.id#" )#" title="#HtmlEditFormat( translateResource( uri="cms:emailcenter.systemTemplates.reset.btn" ) )#">
