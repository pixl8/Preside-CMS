...
<cfoutput>
	<div class="action-buttons">
		...
		<a class="red confirmation-prompt" href="#event.buildAdminLink( linkTo="sitetree.trashPageAction", queryString="asset=#args.id#")#" data-context-key="d" title="#translateResource( uri="cms:sitetree.trash.child.page.link", data=[ safeTitle ] )#">
