...
<table class="table formbuilder-response table-striped">
	<body>
		<tr>
			...
			<td>#renderField( 'formbuilder_question', 'full_question_text', prc.response.full_question_text )#
		...
		<tr>
			...
			<td>
				<cfif ( prc.response.is_website_user || prc.response.is_admin_user) >
					<a href="#event.buildAdminLink( linkto='websiteUserManager.editUser', queryString='id=' & prc.response.website_user )#" target="_blank">
