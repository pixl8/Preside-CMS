...
<cfoutput>
	...
	<cfif IsTrue( args.canDelete ?: "" )>
		<a title="delete this form" class="red confirmation-prompt" href="#event.buildAdminLink( linkto="formbuilder.deleteRecordAction", querystring="id=#args.id#" )#" data-context-key="d">
