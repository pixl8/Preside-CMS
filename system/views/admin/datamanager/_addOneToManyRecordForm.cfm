...
<cfoutput>
	...
	<form id="#formId#" data-auto-focus-form="true" data-dirty-form="protect" data-prevent-multiple-submit="true" class="form-horizontal" method="post" action="#args.addRecordAction#" enctype="multipart/form-data">
