...
<cfoutput>
	<div class="action-buttons btn-group">
		<cfif hasCmsPermission( permissionKey="datamanager.edit", context="datamanager", contextKeys=[ args.objectName ] )>
		...
		<cfsavecontent variable="extraMenuItems">
			<cfif hasCmsPermission( permissionKey="datamanager.viewversions", context="datamanager", contextKeys=[ args.objectName ] )>
				<li>
