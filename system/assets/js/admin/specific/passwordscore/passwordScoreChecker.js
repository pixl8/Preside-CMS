( function( $ ){
	...
	$.fn.passwordScoreChecker = function(){
		var scoreTemplate   = '<div class="password-score"><div class="score-bar-container"><div class="score-bar"></div></div><div class="score-title"></div></div>'
		...
		return this.each( function(){
			...
			showScore = function( scoreData ){
				...
				$scoreContainer.find( ".score-bar" ).css( { width : scoreData.score + "%" } );
