...
component output="false" extends="preside.system.base.SystemPresideObject" displayName="Asset folder" {
	...
	property name="min_width_in_px"      type="numeric" dbtype="float"                 required=false maxValue=1000000;
	property name="max_width_in_px"      type="numeric" dbtype="float"                 required=false maxValue=1000000;
	property name="min_height_in_px"     type="numeric" dbtype="float"                 required=false maxValue=1000000;
	property name="max_height_in_px"     type="numeric" dbtype="float"                 required=false maxValue=1000000;
