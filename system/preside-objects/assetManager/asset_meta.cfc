 ...
 *
 */
component extends="preside.system.base.SystemPresideObject" labelfield="key" output=false displayName="Asset meta data" versioned=false feature="assetManager" {
