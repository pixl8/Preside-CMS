...
component displayname="Form builder: form" extends="preside.system.base.SystemPresideObject" {
	...
	property name="submitted_by" relationship="many-to-one" relatedTo="website_user"     required=false;

	property name="submitted_data" type="string" dbtype="text"                  required=true;
