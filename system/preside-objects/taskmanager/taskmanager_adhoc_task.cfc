...
component extends="preside.system.base.SystemPresideObject"  {
	...
	property name="result_url"     type="string"  dbtype="varchar"  maxlength=2048 required=false;
	property name="return_url"     type="string"  dbtype="varchar"  maxlength=2048 required=false;
