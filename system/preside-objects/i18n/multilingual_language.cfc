...
component extends="preside.system.base.SystemPresideObject"  displayName="Multilingual language" {
	...
	property name="iso_code"      type="string"  dbtype="varchar" maxlength=10  required=true  uniqueindexes="iso_code" format="languageCode";
	property name="slug"          type="string"  dbtype="varchar" maxlength=10  required=false uniqueindexes="slug"     format="slug";
