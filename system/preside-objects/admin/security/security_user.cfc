...
component extends="preside.system.base.SystemPresideObject" labelfield="known_as" output="false" displayName="User" {
	...
	property name="reset_password_token"            type="string"   dbtype="varchar" maxLength="35"  required=false autofilter=false indexes="resettoken";
	...
	property name="two_step_auth_key"               type="string"   dbtype="varchar" maxLength="255" required=false autofilter=false;
	property name="two_step_auth_key_created"       type="date"     dbtype="datetime"                required=false;
