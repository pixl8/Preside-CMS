...
component extends="preside.system.base.SystemPresideObject" labelfield="known_as" output="false" displayName="User" {
	...
	property name="two_step_auth_enabled"           type="boolean"  dbtype="boolean"                 required=false default=false                         renderer="none" sortorder=100 feature="twoFactorAuthentication";
	property name="two_step_auth_key"               type="string"   dbtype="varchar" maxLength="255" required=false autofilter=false                      renderer="none" sortorder=110 feature="twoFactorAuthentication";
	property name="two_step_auth_key_created"       type="date"     dbtype="datetime"                required=false                                       renderer="none" sortorder=120 feature="twoFactorAuthentication";
	property name="two_step_auth_key_in_use"        type="boolean"  dbtype="boolean"                 required=false default=false                                         sortorder=130 feature="twoFactorAuthentication";
