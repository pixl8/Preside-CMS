...
component extends="preside.system.base.SystemPresideObject" labelfield="known_as" output="false" displayName="User" {
	...
	property name="two_step_auth_key_in_use"        type="boolean"  dbtype="boolean"                 required=false default=false                         renderer="none" sortorder=130;
	property name="subscribed_to_all_notifications" type="boolean"  dbtype="boolean"                 required=false default=true sortorder=140;
	property name="last_logged_in"                  type="date"     dbtype="datetime"                required=false ignoreChangesForVersioning=true adminViewGroup="system" sortorder=150;
	property name="last_logged_out"                 type="date"     dbtype="datetime"                required=false ignoreChangesForVersioning=true adminViewGroup="system" sortorder=160;
	property name="last_request_made"               type="date"     dbtype="datetime"                required=false ignoreChangesForVersioning=true adminViewGroup="system" sortorder=170;
