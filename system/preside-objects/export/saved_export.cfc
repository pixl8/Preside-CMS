...
component extends="preside.system.base.SystemPresideObject" {
	...
	property name="created_by"   relationship="many-to-one"  relatedto="security_user" control="none" ondelete=“cascade-if-no-cycle-check” onupdate=“cascade-if-no-cycle-check”;
