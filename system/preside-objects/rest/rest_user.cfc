...
component extends="preside.system.base.SystemPresideObject" {
	...
	property name="access_token" type="string" dbtype="varchar" required=true  maxlength=32  uniqueindexes="token" generate="insert" generator="method:tokenGenerator";
	property name="description"  type="string" dbtype="text"    required=false;

	public string function tokenGenerator() {
