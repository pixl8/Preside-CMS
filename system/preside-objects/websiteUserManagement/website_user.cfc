...
component extends="preside.system.base.SystemPresideObject" labelfield="display_name" output=false displayname="Website user" {
	...
	property name="invalid_login_attempts"      type="numeric"  dbtype="int"                     required=false default="0";
	property name="invalid_login_at"            type="datetime" dbtype="datetime"                required=false;
	property name="lockout_permanently"         type="boolean"  dbtype="boolean"                 required=false default=false;
