...
<!--- properties --->
	...
	property name="created_by"       relationship="many-to-one" relatedTo="security_user"           required=true                                             control="none" generator="LoggedInUser.loggedInUserId" onupdate="cascade-if-no-cycle-check";
	property name="updated_by"       relationship="many-to-one" relatedTo="security_user"           required=true                                             control="none" generator="LoggedInUser.loggedInUserId" onupdate="cascade-if-no-cycle-check";
