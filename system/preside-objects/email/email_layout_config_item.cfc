...
component extends="preside.system.base.SystemPresideObject" displayname="Email layout configuration item"  {
	property name="layout"          type="string" dbtype="varchar"  maxlength=200          required=true  uniqueindexes="layoutconfigitem|1" indexes="layout,layouttemplate|1,layoutblueprint|1"                                                            cloneable=true;
	property name="email_template"  relationship="many-to-one" relatedto="email_template"  required=false uniqueindexes="layoutconfigitem|2" indexes="template,layouttemplate|2"                                                                            cloneable=true;
