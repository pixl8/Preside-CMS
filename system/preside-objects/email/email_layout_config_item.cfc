...
component extends="preside.system.base.SystemPresideObject" displayname="Email layout configuration item"  {
	...
	property name="email_blueprint" relationship="many-to-one" relatedto="email_blueprint" required=false uniqueindexes="layoutconfigitem|3" indexes="template,layoutblueprint|2";
