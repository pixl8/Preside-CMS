...
component accessors=true {
	...
	property name="defaultSystemPageSlug" type="string"  default="";
	...
	public string function getDefaultSystemPageSlug() output=false {
		if ( !getIsSystemPageType() || getId() == "homepage" ) {
			return "";
		}
	...
	public struct function getMemento(){
		return {
			...
			, defaultSystemPageSlug = getDefaultSystemPageSlug()
		};
	}
}