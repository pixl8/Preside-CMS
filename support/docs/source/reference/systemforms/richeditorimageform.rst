    ...
    <form>
        <tab id="main" sortorder="10" title="cms:ckeditor.imagepicker.main.tab">
            <fieldset id="main" sortorder="10">
                ...
                <field sortorder="40" name="alignment"   control="select"  required="false" label="cms:ckeditor.imagepicker.alignment.label" values="auto,left,right" labels="cms:ckeditor.imagepicker.alignment.auto,cms:ckeditor.imagepicker.alignment.left,cms:ckeditor.imagepicker.alignment.right" />
                <field sortorder="50" name="spacing"     control="spinner" required="false" label="cms:ckeditor.imagepicker.spacing.label" default="5" />
            </fieldset>
        </tab>
