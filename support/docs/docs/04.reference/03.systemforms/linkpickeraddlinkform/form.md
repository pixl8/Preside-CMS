---
id: "form-linkpickeraddlinkform"
title: "Link picker: add link form"
---

This form is used for the quick add link modal

<div class="table-responsive"><table class="table table-condensed"><tr><th>File path</th><td>/forms/preside-objects/link/admin.quickadd.xml</td></tr><tr><th>Form ID</th><td>preside-objects.link.admin.quickadd</td></tr></table></div>
