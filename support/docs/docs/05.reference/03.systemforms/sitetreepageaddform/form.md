---
id: "form-sitetreepageaddform"
title: "Sitetree Page: add form"
---

This form is used as the base "add page" form for Sitetree pages. See also [[form-sitetreepageeditform]].

>>> When an add page form is rendered, it gets mixed in with any forms that are defined for the *page type* that is being added.

<div class="table-responsive"><table class="table table-condensed"><tr><th>File path</th><td>/forms/preside-objects/page/add.xml</td></tr><tr><th>Form ID</th><td>preside-objects.page.add</td></tr></table></div>
