---
id: "form-assetfoldereditform"
title: "Asset folder: edit form"
---

This form is used for editing folders in the asset manager section of the administrator.

<div class="table-responsive"><table class="table table-condensed"><tr><th>File path</th><td>/forms/preside-objects/asset_folder/admin.edit.xml</td></tr><tr><th>Form ID</th><td>preside-objects.asset_folder.admin.edit</td></tr></table></div>
