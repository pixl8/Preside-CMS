...
<cfscript>
	...
	apiDocsPath      = "/preside/support/docs/docs/04.reference/api";
	...
	fullPresidePath = ExpandPath( "/preside" );
	apiDocsPath     = "/preside/support/docs/docs/04.reference/presideobjects";
	indexDocPath    = apiDocsPath & "/chapter.md";
	...
	formsDocsPath   = "/preside/support/docs/docs/04.reference/systemforms";
