...
<!--- tests --->
	...
	<cffunction name="test031_2_selectData_shouldSelectDataUsingArrayValuesWithCommas" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/componentsWithRelationship/" ] );
			var result    = "";
	...
	<cffunction name="test031_3_selectData_shouldSelectDataUsingEplicitlyDefinedFilterParamWithArrayValues" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/componentsWithRelationship/" ] );
			var result    = "";
