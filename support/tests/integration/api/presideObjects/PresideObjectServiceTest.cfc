...
<!--- tests --->
	...
	<cffunction name="test080_insertData_shouldAddSiteIdOfCurrentRequest_forObjectsUsingSiteTenantSystem" returntype="void">
		<cfscript>
	...
	<cffunction name="test081_selectData_shouldAutomaticallyFilterBySiteId_whenObjectUsingSiteTenantSystem" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/objectsWithSiteTenants" ] );
	...
	<cffunction name="test082_updateData_shouldAutomaticallyFilterBySiteId_whenObjectUsingSiteTenantSystem" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/objectsWithSiteTenants" ] );
			var obj       = poService.getObject( "object_using_site_tenant" );
	...
	<cffunction name="test083_deleteData_shouldAutomaticallyFilterBySiteId_whenObjectUsingSiteTenantSystem" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/objectsWithSiteTenants" ] );
			var obj       = poService.getObject( "object_using_site_tenant" );
	...
	<cffunction name="test084_selectData_shouldNotAutomaticallyFilterBySiteId_whenObjectUsingSiteTenantSystemButCurrentSiteIdIsEmpty" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/objectsWithSiteTenants" ] );
			var obj       = poService.getObject( "object_using_site_tenant" );
	...
	<cffunction name="test085_dataExists_shouldAutomaticallyFilterByCurrentSite_whenObjectIsUsingSiteTenancy" returntype="void">
		<cfscript>
			var poService = _getService( objectDirectories=[ "/tests/resources/PresideObjectService/objectsWithSiteTenants" ] );
			var obj       = poService.getObject( "object_using_site_tenant" );
	...
	<cffunction name="test086_init_shouldRegisterCustomInterceptionPoints" returntype="void">
		<cfscript>
	...
	<cffunction name="test086_insertData_shouldPopulateUnprovidedFieldsWithTheirDefaultValues" returntype="void">
		<cfscript>
